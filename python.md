...
This project was created using the resources from [Learn X in Y Minutes](https://learnxinyminutes.com/python/). The information and examples provided on this site were used to quickly learn and implement key concepts of the Python programming language.
